...
import static it.units.borghisegreti.CustomMatchers.hasTextInputLayoutErrorText;
...
import it.units.borghisegreti.fragments.RegistrationFragment;
...
public class RegistrationFragmentValidationTests {
    ...
    @Before
    public void init() {
        scenario = FragmentScenario.launchInContainer(RegistrationFragment.class, Bundle.EMPTY, R.style.Theme_AdventureMaps);
