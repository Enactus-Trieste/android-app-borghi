...
public class ExperienceBottomSheetFragment extends BottomSheetDialogFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        icon = viewBinding.experienceIcon;
        title = viewBinding.experienceTitle;
        description = viewBinding.experienceDescription;
        points = viewBinding.experiencePoints;
        objectiveButton = viewBinding.setObjectiveButton;
        ...
        mapViewModel.getExperienceById(Objects.requireNonNull(experienceId, "Experience ID shouldn't be null when the dialog's been initialized")).observe(getViewLifecycleOwner(), experience -> {
            ...
            points.setText(String.format(getString(R.string.gained_points), experience.getPoints()));
            try {
                ...
                icon.setImageResource(R.drawable.ic_baseline_image_not_supported_24);
        ...
        userDataViewModel.getObjectiveExperienceId().observe(getViewLifecycleOwner(), objectiveExperienceId -> {
            ...
            if (objectiveExperienceId != null) {
                objectiveButton.setText(R.string.removeObjective_buttonText);
            } else {
                objectiveButton.setText(R.string.setObjective_buttonText);
            }
        });
        ...
        userDataViewModel.getCompletedExperiencesMap().observe(getViewLifecycleOwner(), completedExperiences -> {
            if (completedExperiences.containsKey(experienceId)) {
                objectiveButton.setVisibility(View.GONE);
        ...
        objectiveButton.setOnClickListener(view -> {
            if (objectiveExperienceId == null) {
